...
``` {r num8}
library(readr)
breastcancer_wisconsin <- read_csv("/cloud/project/Rworksheet#6_Sante/breastcancer_wisconsin.csv", show_col_types = FALSE)
...
library(readr)
abalone <- read_csv("/cloud/project/Rworksheet#6_Sante/abalone.csv")
abalone
head(abalone)
summary(abalone)
```
